...
var mainMenuButton = document.querySelector(".main-menu__toggle");
...
mainMenuButton.addEventListener("click", function (e) {
  ...
  mainMenuButton.classList.remove("main-menu__toggle--closed");
  }else if(mainMenu.classList.contains("main-menu--opened")) {
    mainMenu.classList.add("main-menu--closed");
    mainMenu.classList.remove("main-menu--opened");
    mainMenuButton.classList.add("main-menu__toggle--closed");
  };
});
